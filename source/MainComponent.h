...
private:
    ...
    juce::TextButton m_quatsOscActive, m_rollOscActive, m_pitchOscActive, m_yawOscActive, m_rpyOscActive;
    ...
    juce::Label m_quatsOscAddress, m_rollOscAddress, m_pitchOscAddress, m_yawOscAddress, m_rpyOscAddress;
    ...
    const juce::Colour cgrnsh = juce::Colour::fromRGBA (101, 200, 158, 255); // light greenish
    const juce::Colour cred = juce::Colour::fromRGBA (255, 0, 0, 255); // red

    // fonts
    const juce::Font titlefontA = juce::Font (juce::Typeface::createSystemTypefaceFor (BinaryData::Tbold_ttf, BinaryData::Tbold_ttfSize));
    const juce::Font titlefontB = juce::Font (juce::Typeface::createSystemTypefaceFor (BinaryData::segoeui_ttf, BinaryData::segoeui_ttfSize));
    const juce::Font labelfont = juce::Font (juce::Typeface::createSystemTypefaceFor (BinaryData::segoeui_ttf, BinaryData::segoeui_ttfSize));

    // images
    juce::Image iserial = juce::ImageCache::getFromMemory (BinaryData::serial_png, BinaryData::serial_pngSize);
    juce::Image iaxis = juce::ImageCache::getFromMemory (BinaryData::axis_png, BinaryData::axis_pngSize);
    juce::Image iosc = juce::ImageCache::getFromMemory (BinaryData::osc_png, BinaryData::osc_pngSize);
