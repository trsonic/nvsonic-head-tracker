...
void Bridge::pushQuaternionVector()
{
    ...
    if (m_quatsActive)
    {
        ...
        {
            sender.send (m_quatsOscAddress, m_quatsSigns[0] * quats[m_quatsOrder[0]], m_quatsSigns[1] * quats[m_quatsOrder[1]], m_quatsSigns[2] * quats[m_quatsOrder[2]], m_quatsSigns[3] * quats[m_quatsOrder[3]]);
        }
    }
