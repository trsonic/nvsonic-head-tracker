...
![nvsonic head tracker mounted on a headphone headband](docs/images/ht_white_bg.jpg)
...
![MPU-9250 and MPU-9150 IMU boards](docs/images/mpu9250_9150.png)
![Arduino Pro Micro board](docs/images/arduino_promicro.png)
![Gold pin connectors](docs/images/gold_pin_connector.jpg)
![Wires with gold pin connectors](docs/images/gold_pin_wires.png)
![Micro USB cable](docs/images/micro_usb_cable.jpg)
...
![IMU and Arduino board wiring diagram](docs/images/schematic.png)
...
![MRJ LAB 3d printed enclosure](docs/images/rj_lab_enclosure.jpg)
...
![Correctly oriented IMU sensor](docs/images/sensor_headband.png)
...
![nvsonic OSC HT Bridge GUI](docs/images/MPU9250_axes.jpg)
...
![nvsonic OSC HT Bridge GUI](docs/images/app_gui.png)
...
![Reaper settings](docs/images/reaper_fx_processing.png)
